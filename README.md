...
Built as a portfolio project to demonstrate practical Data Engineering skills using ADLS GEN 2 , Azure Key Vault, Snowflake , dbt Core , Apache Airflow and Docker.
...
![Gold Model](docs/images/data_model.png)
...
Interactive dashboard built on the Gold Layer generated by dbt and orchestrated by Airflow.

![Power BI Dashboard](docs/images/dashboard.png)

### Dashboard Features

- Operational KPIs and flight summary
- Flight status analysis
- Airline performance overview
- Airport activity analysis
- Time-based flight trends
